...
class Form extends Generic
{
    ...
    {
        $model = $this->_coreRegistry->registry('movie_director');
        ...
        $fieldset = $form->addFieldset(
            'base_fieldset',
            ['legend' => __('Director Information'), 'class' => 'fieldset-wide']
        );
        ...
        $fieldset->addField(
            'director_name',
            'text',
            ['name' => 'director_name', 'label' => __('Director Name'), 'title' => __('Director Name'), 'required' => true]
        );
